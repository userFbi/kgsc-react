...
const STEPS = ["Photo", "Aadhar", "Address"];
...
export default function CompleteProfile() {
    ...
    function validateStep() {
        ...
        if (step === 1) {
            ...
            if (!/^\d{12}$/.test(digits)) errs.aadhar = "Enter a valid 12-digit Aadhar number.";
        }
        if (step === 2) {
            ...
            <div className="cp-card">
                ...
                <div className="cp-progress">
                    {STEPS.map((label, i) => (
                        ...
                        >
                            <span className="cp-progress-dot">{i < step ? <i className="bi bi-check-lg"></i> : i + 1}</span>
                    ...
                    <div className="cp-step">
                        <div className="cp-photo-upload">
                            <div className="cp-photo-circle">
                                {photoPreview ? <img src={photoPreview} alt="Preview" /> : <i className="bi bi-person-fill"></i>}
                            </div>
                            ...
                            <p className="cp-hint">A clear photo of your face. JPG or PNG, up to 5MB.</p>
                        </div>
                    </div>
                )}
                ...
                {step === 1 && (
                    <div className="cp-step">
                        ...
                        <p className="cp-hint">Used only to verify your membership. Never shared publicly.</p>
                    </div>
                )}
                ...
                {step === 2 && (
                    <div className="cp-step">
                        ...
                        <p className="cp-hint">Just your basic address is fine — no need for exact pincode.</p>
                    </div>
                )}
                ...
                <div className="cp-actions">
                    ...
                    <button type="button" className="cp-btn cp-btn-primary" onClick={goNext} disabled={loading}>
                        {loading ? "Saving..." : step === STEPS.length - 1 ? "Save & continue" : "Next"}
                    </button>
                </div>
